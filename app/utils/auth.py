...
# Load secret key or use a default one for development
SECRET_KEY = os.getenv("SECRET_KEY", "sentinelstream_super_secret_key_123!_change_in_production")
ALGORITHM = "HS256"
...
class RoleChecker:
    """Enforce specific roles on endpoints."""
